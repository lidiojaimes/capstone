...
They need to move row 3 for "Lesion Location" section to row 2. Location of stroke variable doesn't tell us anything in R, has a 1 if they had it in the brainstem, 0 otherwise. 
