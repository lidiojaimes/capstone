...
mdl1_data <- 
  ...
  select(id_number, admission_nihss, admission_mrs_score, # location_of_stroke,
...
predM[, c("log_lengthhospitalstay")] <- 0

imp2 <- mice(mdl1_data_imp, maxit = 5, 
