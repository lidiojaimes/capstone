...
mdl2_tree1 <- tree(discharge_location ~ .#, minsize=2, mindev=0,
                   data=mdl2.train)
#look into tree.control, can control child node. min size, this way no pruning
#tree() 
...
for (i in 1:100) {
  ...
  # Fit the tree
  tree_i <- tree(discharge_location ~ .,
                 data = train_i)
  # Prune based on CV
...
#can use the mult lin regr model to siggest which variables to look at when admitted patients come in 
